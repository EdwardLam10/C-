...
*****************************************************/
    ...
    void QueryTree( const string x , AvlNode *t ) 
    {
        if( t == nullptr )
            cout  << "Not Found" << endl;
     ...
     * Returns the number of nodes in the tree
     */
    int aDepth( AvlNode *t, int sumDepth ) 
    {
        if( t == nullptr ){
            return 0;
        } else {
    ...
    pair<bool, int> find( const string x , AvlNode *t, pair<bool, int> result ) 
    {   
        if( t == nullptr ){
            result.first = false;
    ...
    pair<bool, int> del( const string x, AvlNode * & t, pair<bool, int> result )
    {
        if( t == nullptr ) {
            result.first = false;
            result.second += 1;
